// Pure line differ shared by every surface that shows a change: the desktop
// file panel's Diff view, and the CLI's inline edit rendering. Produces a full
// (un-hunked) unified diff as DiffLine[]; callers decide how to display it.
// Dependency-free + side-effect-free so it's trivially testable.
//
...
// split on '\n' so a diff row's oldNo/newNo line up with the file as numbered
// by an editor.
