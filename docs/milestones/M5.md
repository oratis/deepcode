...
- `plugins/manifest.test.ts` — covers manifest validation, deterministic whole-plugin-tree hash sensitivity (including executable code and SKILL.md), trust round-trip, install, direct data-directory discovery, drift detection, disabled list, and untrusted skip
